...
public class LessonService
    ...
    public LessonService(LessonRepository repository, LessonMapper mapper, LessonValidator validator, ModuleRepository moduleRepository, TelegramService telegramService) {
